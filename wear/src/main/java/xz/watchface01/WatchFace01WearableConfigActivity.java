...
/* Watchface configuration. Based on the demo from Google Android Studio tutorial. */
...
/**
 * The watch-side config activity for {@link MyWatchFace}, which allows for setting the
 * background color.
 */
public class WatchFace01WearableConfigActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_watch_face01_config);
    ...
    private void updateConfigDataItem(final int backgroundColor) {
        ...
        Log.d(MyWatchFace.TAG,"updateConfigDataItem() called");
    }
    ...
    private class ColorListAdapter extends WearableListView.Adapter {
        ...
        public void onBindViewHolder(WearableListView.ViewHolder holder, int position) {
            ...
            int colorPickerItemMargin = (int) getResources()
                    .getDimension(R.dimen.watch_face01_config_color_picker_item_margin);
    ...
    private static class ColorItem extends LinearLayout implements
        ...
        private void setColor(String colorName) {
            ...
            if (colorName.equals(getResources().getString(R.string.color_default))){
                mColor.setCircleColor(getResources().getColor(R.color.default_background_color));
            }else {
